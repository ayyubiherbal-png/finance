...
export const KAMUS = {
  ...
  'menu.settlementMarketplace': { id: 'Settlement Marketplace', en: 'Marketplace Settlement' },
  'menu.pengeluaranKas': { id: 'Pengeluaran Kas', en: 'Cash Expense' },
  ...
  'menu.riwayatPerubahan': { id: 'Riwayat Perubahan', en: 'Change History' },
  ...
  'topbar.bukaMenu': { id: 'Buka menu', en: 'Open menu' },
  'topbar.tutupMenu': { id: 'Tutup menu', en: 'Close menu' },
  'topbar.menuUtama': { id: 'Menu utama', en: 'Main menu' },
  ...
  'dasbor.subjudulAksi': { id: 'Ringkasan bisnis dan hal yang perlu ditindaklanjuti', en: 'Business summary and items requiring action' },
  'dasbor.pilihPeriode': { id: 'Pilih periode', en: 'Select period' },
  'dasbor.hari': { id: 'hari', en: 'days' },
  'dasbor.bulanIni': { id: 'Bulan ini', en: 'This month' },
  'dasbor.lihatLaporan': { id: 'Lihat laporan', en: 'View report' },
  'dasbor.kinerjaHari': { id: 'Kinerja {n} hari', en: '{n}-day performance' },
  'dasbor.penjualanBersih': { id: 'Penjualan bersih', en: 'Net sales' },
  'dasbor.bebanOperasional': { id: 'Beban operasional', en: 'Operating expenses' },
  'dasbor.labaOperasional': { id: 'Laba operasional', en: 'Operating profit' },
  'dasbor.perluTindakanHariIni': { id: 'Perlu tindakan hari ini', en: 'Needs attention today' },
  'dasbor.produkPerluRestock': { id: 'produk perlu restock', en: 'products need restocking' },
  'dasbor.semuaStokAman': { id: 'Semua stok produk aman', en: 'All product stocks are safe' },
  'dasbor.fakturPerluDitagih': { id: 'Ada faktur yang perlu ditagih', en: 'Invoices require collection' },
  'dasbor.tidakAdaFaktur': { id: 'Tidak ada faktur belum lunas', en: 'No unpaid invoices' },
  'dasbor.pesananMenunggu': { id: '{n} pesanan menunggu diproses', en: '{n} orders awaiting processing' },
  'dasbor.tidakAdaPesananMenunggu': { id: 'Tidak ada pesanan yang tertunda', en: 'No pending orders' },
  'dasbor.settlementMenunggu': { id: '{n} pesanan menunggu settlement', en: '{n} orders awaiting settlement' },
  'dasbor.tidakAdaSettlementMenunggu': { id: 'Semua settlement sudah cocok', en: 'All settlements are reconciled' },
  'dasbor.fakturJatuhTempo': { id: '{n} faktur sudah jatuh tempo', en: '{n} invoices are overdue' },
  'dasbor.tidakAdaJatuhTempo': { id: 'Tidak ada faktur jatuh tempo', en: 'No overdue invoices' },
  'dasbor.diperbaruiPada': { id: 'Data diperbarui', en: 'Data updated' },
  'dasbor.perbaruiData': { id: 'Perbarui data dashboard', en: 'Refresh dashboard data' },
  'dasbor.perbarui': { id: 'Perbarui', en: 'Refresh' },
  'dasbor.trenPenjualanBersih': { id: 'Tren penjualan bersih', en: 'Net sales trend' },
  'dasbor.posisiSaatIni': { id: 'Posisi saat ini', en: 'Current position' },
  'dasbor.kasSaatIni': { id: 'Kas & bank saat ini', en: 'Current cash & bank' },
  'dasbor.piutangSaatIni': { id: 'Piutang berjalan saat ini', en: 'Current receivables' },
  'dasbor.persediaanSaatIni': { id: 'Nilai persediaan saat ini', en: 'Current inventory value' },
  'dasbor.hutangSaatIni': { id: 'Utang supplier saat ini', en: 'Current supplier payables' },
  'dasbor.kesehatanBisnis': { id: 'Kesehatan bisnis', en: 'Business health' },
  'dasbor.marginKotor': { id: 'Margin laba kotor', en: 'Gross margin' },
  'dasbor.rasioBeban': { id: 'Rasio beban terhadap penjualan', en: 'Expense-to-sales ratio' },
  'dasbor.lihatRincian': { id: 'Lihat rincian', en: 'View details' },
  'dasbor.produkTerlaris': { id: 'Produk terlaris', en: 'Top-selling products' },
  'dasbor.terjual': { id: 'terjual', en: 'sold' },
  'dasbor.transaksi': { id: 'transaksi', en: 'transactions' },
  'dasbor.vsPeriodeSebelumnya': { id: 'vs periode sebelumnya', en: 'vs previous period' },
  ...
  'dasbor.pengeluaran30Hari': { id: 'Pengeluaran (30 hari)', en: 'Expenses (30 days)' },
  'dasbor.labaBersih30Hari': { id: 'Laba bersih (30 hari)', en: 'Net profit (30 days)' },
...
export const TEKS: Record<string, string> = {
  ...
  'Belum ada varian lain.': 'No other variants yet.',
  'Belum ada kategori biaya.': 'No expense categories yet.',
  'Belum ada Pengeluaran Kas.': 'No cash expenses yet.',
  ...
  'Pengeluaran kas tersimpan.': 'Cash expense saved.',
  'Pengeluaran kas dibatalkan.': 'Cash expense cancelled.',
  'Nama pengeluaran tersimpan.': 'Expense name saved.',
  'Nama pengeluaran dihapus.': 'Expense name deleted.',
  'Memuat jumlah nama pengeluaran...': 'Loading expense name count...',
  '{n} nama pengeluaran di kategori ini.': '{n} expense names in this category.',
  '{n} Pengeluaran Kas pakai nama pengeluaran ini.': '{n} Cash Expenses use this expense name.',
  ...
  'Pengelompokan biaya operasional untuk Pengeluaran Kas': 'Grouping of operating expenses for Cash Expenses',
  'Kode kategori (induk) mengelompokkan Nama Pengeluaran (sub-kode) untuk Pengeluaran Kas':
    'Category code (parent) groups Expense Names (sub-code) for Cash Expenses',
  'Cari kategori atau nama pengeluaran...': 'Search category or expense name...',
  'Belum ada nama pengeluaran di kategori ini.': 'No expense names in this category yet.',
  'Nama Pengeluaran': 'Expense Name',
  'Nama pengeluaran': 'Expense name',
  'Nama Pengeluaran Baru': 'New Expense Name',
  'Pilih nama pengeluaran...': 'Select expense name...',
  'Belum ada nama pengeluaran. Tambahkan dulu di menu Kategori Biaya.': 'No expense names yet. Add one first from the Expense Categories menu.',
  'Pengeluaran Kas': 'Cash Expense',
  'Biaya operasional umum -- sewa, listrik, gaji, dll, tanpa faktur supplier': 'General operating expenses -- rent, electricity, salaries, etc., without a supplier invoice',
  'Catat Pengeluaran': 'Record Expense',
  'Tambah Varian': 'Add Variant',
  Varian: 'Variant',
  '{n} varian': '{n} variants',
  'Varian dari:': 'Variant of:',
  'Membuat varian dari:': 'Creating a variant of:',
  ...
  'Excel (CSV)': 'Excel (CSV)',
  PDF: 'PDF',
  'Tidak ada data untuk diekspor.': 'No data to export.',
  Pesanan: 'Orders',
  ...
  'Pengelompokan produk untuk filter & pelaporan': 'Product grouping for filtering & reporting',
  ...
  '{n} pengeluaran kas masih pakai kategori ini -- kategorinya akan jadi kosong. Yakin hapus?':
    '{n} cash expense(s) still use this category -- it will become empty for them. Delete anyway?',
  'Batalkan pengeluaran kas ini?': 'Cancel this cash expense?',
  'Pilih kategori biaya.': 'Select an expense category.',
  'Pilih akun kas/bank sumber pengeluaran ini.': 'Select the cash/bank account this expense comes from.',
  'Jumlah harus lebih dari 0.': 'The amount must be greater than 0.',
  'Pilih kategori.': 'Select a category.',
  'Pilih nama pengeluaran.': 'Select an expense name.',
  'Hapus nama pengeluaran ini?': 'Delete this expense name?',
  'Masih ada {n} nama pengeluaran di kategori ini -- hapus atau pindahkan dulu sebelum menghapus kategorinya.':
    'There are still {n} expense name(s) in this category -- delete or move them first before deleting the category.',
  'Masih ada {n} Pengeluaran Kas yang pakai nama pengeluaran ini -- tidak bisa dihapus.':
    'There are still {n} Cash Expense(s) using this expense name -- it cannot be deleted.',
  ...
  'Tambahkan minimal satu produk.': 'Add at least one product.',
  'Purchase Order tersimpan dan disetujui.': 'Purchase Order saved and approved.',
  'Sales Order tersimpan dan disetujui.': 'Sales Order saved and approved.',
  'Penyesuaian tersimpan dan diposting.': 'Stock adjustment saved and posted.',
  'Tambah Produk': 'Add Product',
  'Simpan & Setujui': 'Save & Approve',
  'Simpan & Posting': 'Save & Post',
  'Simpan & Terima Barang': 'Save & Receive Goods',
  'Simpan & Kirim Barang': 'Save & Ship Goods',
  '"Simpan & Terima Barang" langsung menambah stok gudang': '"Save & Receive Goods" immediately adds stock to warehouse',
  '"Simpan & Kirim Barang" langsung mengurangi stok gudang': '"Save & Ship Goods" immediately reduces warehouse stock',
  'Qty (+/-)': 'Qty (+/-)',
  'Retur Semua & Posting': 'Return All & Post',
  'Lanjut Isi Barang': 'Continue Adding Items',
  'Retur seluruh barang tersimpan dan diposting.': 'The full return was saved and posted.',
  'Faktur tidak memiliki item yang dapat diretur.': 'The invoice has no items available to return.',
  'Penerimaan Barang tidak memiliki item yang dapat diretur.': 'The goods receipt has no items available to return.',
  'Biaya Operasional': 'Operating Expenses',
  'Laba Bersih': 'Net Profit',
  'Memuat jumlah produk...': 'Loading product count...',
  '{n} produk pakai kategori ini.': '{n} products use this category.',
  'Memuat jumlah pengeluaran...': 'Loading expense count...',
  '{n} pengeluaran kas pakai kategori ini.': '{n} cash expenses use this category.',
  'Belum ada kategori biaya. Tambahkan dulu di menu Kategori Biaya.': 'No expense categories yet. Add one first from the Expense Categories menu.',
  ...
  'Total 100 pengeluaran teratas yang tampil': 'Showing top 100 expenses',
  'Total 100 SO teratas yang tampil': 'Showing top 100 sales orders',
  'Menampilkan {awal}-{akhir} dari {total}': 'Showing {awal}-{akhir} of {total}',
  'Halaman {halaman} dari {total}': 'Page {halaman} of {total}',
  'Halaman sebelumnya': 'Previous page',
  'Halaman berikutnya': 'Next page',
  '{jumlah} baris dipilih': '{jumlah} rows selected',
  'Batalkan pilihan': 'Clear selection',
  'Pilih semua di halaman ini': 'Select all on this page',
  'Pilih baris {nomor}': 'Select row {nomor}',
  ...
  // ---------- P0: konfirmasi, audit, settlement ----------
  'Konfirmasi tindakan': 'Confirm action',
  Lanjutkan: 'Continue',
  'useKonfirmasi harus dipakai di dalam PenyediaKonfirmasi': 'useKonfirmasi must be used inside PenyediaKonfirmasi',
  'Riwayat Perubahan': 'Change History',
  'Jejak siapa mengubah data penting dan kapan perubahan terjadi.': 'See who changed important data and when.',
  Sistem: 'System',
  'Semua data': 'All data',
  ...
  Diubah: 'Updated',
  Dihapus: 'Deleted',
  'Belum ada riwayat. Perubahan data akan tercatat otomatis setelah migrasi dijalankan.': 'No history yet. Data changes will be recorded automatically after the migration runs.',
  Waktu: 'Time',
  Pengguna: 'User',
  Data: 'Data',
  Tindakan: 'Action',
  Ringkasan: 'Summary',
  'Settlement Marketplace': 'Marketplace Settlement',
  'Cocokkan omzet bruto, potongan platform, dan dana bersih yang masuk.': 'Reconcile gross sales, platform deductions, and net funds received.',
  'Isi nomor settlement, akun bank, dan pilih minimal satu pesanan.': 'Enter the settlement number and bank account, then select at least one order.',
  'Total potongan tidak boleh melebihi omzet bruto.': 'Total deductions cannot exceed gross sales.',
  'Settlement berhasil direkonsiliasi.': 'Settlement reconciled successfully.',
  'Settlement dibatalkan.': 'Settlement cancelled.',
  'Settlement Baru': 'New Settlement',
  'Nomor settlement': 'Settlement number',
  'Nomor pencairan platform': 'Platform payout number',
  'Pesanan dalam pencairan': 'Orders in payout',
  'Tidak ada pesanan': 'No orders',
  'yang masih menunggu settlement.': 'are awaiting settlement.',
  Faktur: 'Invoice',
  'Sisa bruto': 'Remaining gross amount',
  'Fee platform': 'Platform fee',
  'Voucher toko': 'Store voucher',
  'Ongkir dipotong': 'Shipping deduction',
  Refund: 'Refund',
  'Omzet bruto': 'Gross sales',
  'Total potongan': 'Total deductions',
  'Dana diterima': 'Funds received',
  'Rekonsiliasi & Posting': 'Reconcile & Post',
  ...
  'Cari nama atau sumber...': 'Search name or source...',
